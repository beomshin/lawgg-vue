...
const END_POINT = {
    ...
    LOGIN_ANONYMOUS_BOARD: '/api/public/v1/login/board', // 익명 게시판 로그인
    LOGIN_USER_BOARD: '/api/v1/board/login/board', // 회원 게시판 로그인
    ...
    RECOMMEND_BOARD: '/api/v1/recommend/board', // 게시판 추천
    DELETE_RECOMMEND_BOARD: '/api/v1/delete/recommend/board', // 게시판 추천 삭제
