...
const END_POINT = {
    ...
    DELETE_USER_TRIAL: '/api/v1/delete/trial', // 트라이얼 게시판 삭제(회원)
    ...
    RECOMMEND_TRIAL: '/api/v1/recommend/trial', // 트라이얼 게시판 추천
    DELETE_RECOMMEND_TRIAL: '/api/v1/delete/recommend/trial', // 트라이얼 추천 삭제
    REPORT_TRIAL: '/api/public/v1/report/trial', // 트라이얼 신고
    VOTE_TRIAL: '/api/v1/vote/trial', // 트라이얼 투표
