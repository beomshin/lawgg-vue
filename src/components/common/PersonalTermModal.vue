<template>
  <modal class="modal-area" name="modalPersonalTerms" width="90%"  height="auto" :maxWidth="450" :adaptive="true" :scrollable="true">
    <dl class="ma-header">
      <dt>개인정보처리방침</dt>
      <dd @click="$modal.hide('modalPersonalTerms')"><i class="uil uil-times"></i></dd>
    </dl>

    <div class="ma-terms">
      <h3>개인정보처리방침</h3>
      <div>
        본 개인정보처리방침은 ㈜로우지지(이하 “회사”라 합니다)가 제공하는 서비스(이하 “서비스”)의 이용과 관련하여, 회사의 회원으로 가입한 뒤 서비스를 이용하는 회원(이하 “회원”)로부터 수집하는 개인정보 및 그 개인정보의 사용방법 등에 관한 제반사항을 규정하기 위해 준비되었습니다.<br><br>
      ...
      <div>
        ...
        1. 「https://lawgg.kr」 의 정보통신망의 유지 및 운영 서비스<br><br>
      ...
      <div>
        ...
        1) 회원의 이메일주소<br><br>
        2) 회원이 라이엇게임즈코리아 유한회사(Riot Games Korea, Ltd.)에 등록한 계정과의 연동을 위한 식별자<br><br>
        3) 회원이 게임을 실행하여 누적한 전적(승패 등) 등 게임자료 일체에 관한 정보<br><br>
        4) 위 2)와 위 3) 각 기재 정보를 결합하여 생성한 정보<br><br><br>
        ...
        5) 회원이 라이엇게임즈코리아 유한회사(Riot Games Korea, Ltd.)에 등록한 계정과의 연동을 위한 식별자<br><br>
      ...
      <div>
        ...
        2) 회원이 라이엇게임즈코리아 유한회사(Riot Games Korea, Ltd.)에 등록한 계정과의 연동을 위한 식별자,<br><br>
        3) 회원이 게임을 실행하여 누적한 전적(승패 등) 등 게임자료 일체에 관한 정보,<br><br>
        4) 위 2)와 위 3) 각 기재 정보를 결합하여 생성한 정보<br><br>
      ...
      <div>
        ...
        - 수탁업체: Amazon Web Services, Inc.<br><br>
        - 위탁업무 내용 : 데이터보관 및 서비스 운영<br><br>
        - 개인정보의 보유 및 이용기간 : 회원의 탈퇴시 또는 위탁 계약 종료시까지<br><br>

        ※ 회사는 Amazon Web Services, Inc.의 대한민국 내 서버를 이용하고 있으므로, 위탁된 개인정보는 국외로 이전되지 않습니다.
      </div>
